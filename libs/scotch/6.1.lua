-- -*- lua -*-
--[==[
# Module:          lib/scotch/6.1-gnu-10.2-mpi-4.0
# Revision:        esbw01 20201002 Alexandru Saramet
# License:         GPL v3
...
local version = "6.1"
local folder = version.."-gnu-10.2-mpi-4.0"
...
whatis("SCOTCH library and tools version "..version, "for compiler/gnu/10.2")
