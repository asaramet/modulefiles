-- -*- lua -*-
--[==[
# Module:          lib/cgal/4.14.3-gnu-10.2.0
# Revision:        esbw01 20201005 Alexandru Saramet
# License:         GPL v3
...
local version = "4.14.3"
local folder = version.."-gnu-10.2.0"
