--[==[
# Module:          cae/cgns/3.4.1-intel-19.1
# Revision:        esbw01
# License:         Free
...
local version = "3.4.1"
local base_dir = pathJoin("/opt/bwhpc/common/cae/cgns", version)
...
depends_on("lib/hdf5/1.12.0-intel-19.1", "compiler/intel/19.1")

conflict("cae/cgns")

whatis("CGNS library and tools version "..version.." for Intel Compiler 19.1")
