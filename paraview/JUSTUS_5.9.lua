...
# Date:            20210709 Alexandru Saramet
### END COMMENTS
]==]--

local version = "5.9.1"
local base_dir = pathJoin("/opt/bwhpc/common/vis/paraview", version.."_impi-2019.8-intel-19.1.2-python-3.8.3")
...
--depends_on("devel/python/3.8.3", "compiler/intel/19.1.2", "mpi/impi/2019.8")
depends_on("numlib/python_scipy/1.5.0_numpy-1.19.0_python-3.8.3", "compiler/intel/19.1.2", "mpi/impi/2019.8")
