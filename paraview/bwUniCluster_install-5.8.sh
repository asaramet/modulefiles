...
module load devel/python/3.8.3_intel_19.1
...
mkdir tmp
cd tmp
#cmake ${BUILD_DIR}/${NAME} -DCMAKE_INSTALL_PREFIX=${TARGET_DIR} -Wno-dev -DCMAKE_BUILD_TYPE=Release \
#cmake ${BUILD_DIR}/${NAME} -DCMAKE_INSTALL_PREFIX=${TARGET_DIR} \
