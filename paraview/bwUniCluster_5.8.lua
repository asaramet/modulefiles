...
# Module:          cae/paraview/5.8
# Revision:        esbw01
# TargetSystem:    Red-Hat-Enterprise
# MainLocation:    /opt/bwhpc/common/cae/paraview/5.8.1
# Status:          optional
# License:         BSD
# URL:             https://www.paraview.org
# 2ndLevelSupport: cluster-support[at]hs-esslingen.de
# Date:            20200807 Alexandru Saramet
### END COMMENTS
]==]--
...
depends_on("devel/python/3.8.3_intel_19.1", "mpi/impi/2020")
