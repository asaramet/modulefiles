...
# Module:          es/cae/starccm+/2019.2-r8
# Revision:        esbw01
# TargetSystem:    Red-Hat-Enterprise
# MainLocation:    /opt/bwhpc/common/es/cae/starccm+/14.04.013-R8
# Status:          optional
# License:         Private/Corporate
# 2ndLevelSupport: cluster-support[at]hs-esslingen.de
# Date:            20200305 Alexandru Saramet
# InstallDoc:      install-14.04-r8.sh
### END COMMENTS
]==]--

local version = "14.04.013-R8"
...
--depends_on("compiler/gnu/9.2", "mpi/impi/2018","system/ssh_wrapper/0.1")
