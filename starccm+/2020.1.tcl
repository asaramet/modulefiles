#%Module2.0
#
# Module:       esslingen/starccm/2020.1
# Revision:     esbw00
# TargetSystem: RHEL7
# Priority:		optional
...
# ./STAR-CCM+15.02.009_01_linux-x86_64-2.5_gnu4.8-r8.bin -i console
#
# ## follow the steps
# ## set path to:
# # /opt/bwhpc/common/cae/star-ccm+/2020.1
#
###

set 	version		"15.02.009"
set		base_dir	"/opt/bwhpc/common/cae/star-ccm+/2020.1/${version}/STAR-CCM+${version}"
