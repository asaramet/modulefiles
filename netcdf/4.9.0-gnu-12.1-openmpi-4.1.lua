...
# Module:          lib/netcdf/4.9.0-gnu-12.1-openmpi-4.1
# Revision:        esbw01
# TargetSystem:    Red-Hat-Enterprise
# MainLocation:    /opt/bwhpc/common/lib/netcdf/4.9.0-gnu-12.1-openmpi-4.1
# Status:          optional
# License:         GPL v3
# URL:             https://www.unidata.ucar.edu/software/netcdf/
# 2ndLevelSupport: cluster-support[at]hs-esslingen.de
# Date:            20220810 Alexandru Saramet
# InstallDoc:      scripts/install_netcdf.sh
### END COMMENTS
]==]--

local version = "4.9.0-gnu-12.1-openmpi-4.1"
...
load("lib/hdf5/1.12.2-gnu-12.1-openmpi-4.1")
conflict("lib/netcdf")

whatis("netcdf-c library version 4.9.0 for GNU compiler with OpenMPI, netcdf-cxx4 version 4.3.1 and netcdf-fortran version 4.5.4")

if ( mode() == "load" ) then
  LmodMessage("NetCDF "..version, "is loaded.", "Available are netcdf-c-4.9.0, netcdf-cxx4-4.3.1, netcdf-fortran-4.5.4")
end
