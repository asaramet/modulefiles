...
# Module:          lib/netcdf/4.9.0-intel-2021.4-impi-2021.4
# Revision:        esbw01
# TargetSystem:    Red-Hat-Enterprise
# MainLocation:    /opt/bwhpc/common/lib/netcdf/4.9.0-intel-2021.4-impi-2021.4
# Status:          optional
# License:         GPL v3
...
local version = "4.9.0-intel-2021.4-impi-2021.4"
...
load("lib/hdf5/1.12.2-intel-2021.4.0-impi-2021.4.0")
conflict("lib/netcdf")

whatis("netcdf-c library version 4.9.0 for Intel compiler with Intel MPI, netcdf-cxx4 version 4.3.1 and netcdf-fortran version 4.5.4")
