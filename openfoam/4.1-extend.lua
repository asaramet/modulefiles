-- -*- lua -*-
--[==[
# Module:          cae/openfoam/4.1-extend
# Revision:        esbw01 20210201 Alexandru Saramet
# License:         GPL v3
...
local version = "4.1"
local openfoam = "foam-extend-"..version
local base_dir = pathJoin("/opt/bwhpc/common/cae/openfoam", version.."-extend")
...
whatis("Open Source CFD Toolbox OpenFOAM fork extend version "..version)
