-- -*- lua -*-
--[==[
# Revision:        esbw01 20200921 Alexandru Saramet
# License:         GPL v3
...
local base_dir = pathJoin("/opt/bwhpc/common/cae/openfoam", version.."_openmpi-"..mpi.."-gnu-"..gnu)
...
depends_on("compiler/gnu/"..gnu, "mpi/openmpi/"..mpi)
