...
sed -i s:boost_version=boost-system:boost_version=boost_1_69_0:g $TARGET_DIR/OpenFOAM-${VERSION}/etc/config.sh/CGAL
sed -i s:cgal_version=cgal-system:cgal_version=CGAL-4.10:g $TARGET_DIR/OpenFOAM-${VERSION}/etc/config.sh/CGAL
