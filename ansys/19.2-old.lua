-- -*- lua -*-
--[==[
# Module:          es/cae/ansys/19.2
# Revision:        esbw01 20200309 Alexandru Saramet
# License:         Commercial
...
local mpi_home = os.getenv("MPI_ROOT") or ""
setenv("CFX5_IMPI_DIR", pathJoin(mpi_home, "intel64"))

local ssh = "/opt/bwhpc/common/system/ssh_wrapper/0.1/ssh"
setenv("MPI_REMSH", ssh)
setenv("CFX5RSH", ssh)
setenv("I_MPI_MPD_RSH", ssh)
...
In order to run the ANSYS Workbench, enter 'runwb2'.
