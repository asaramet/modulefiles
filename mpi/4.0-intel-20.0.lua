...
whatis("OpenMPI bindings (mpicc mpicxx mpifort) version "..version.."for intel/20.0")
...
(intel/20.0) module should (and automatically will) be loaded first.
