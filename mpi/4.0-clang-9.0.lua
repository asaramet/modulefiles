...
# Module:          mpi/openmpi/4.0.3rc3-clang-9.0
# Revision:        esbw11
# TargetSystem:    RHEL64
# MainLocation:    /opt/bwhpc/common/mpi/openmpi/4.0.3rc3-clang-9.0
# Status:          optional
...
local version  = "4.0.3rc3-clang-9.0"
...
whatis("OpenMPI bindings (mpicc mpicxx mpifort) version "..version.."for clang/9.0")
...
(clang/9.0) module should (and automatically will) be loaded first.
...
The full version is: 4.0.3rc3-clang-9.0
