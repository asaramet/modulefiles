...
# Module:          mpi/openmpi/4.0.3rc3-intel-20.0
# Revision:        esbw11
# TargetSystem:    RHEL64
# MainLocation:    /opt/bwhpc/common/mpi/openmpi/4.0.3rc3-intel-20.0
# Status:          optional
...
local version  = "4.0.3rc3-intel-20.0"
...
whatis("OpenMPI bindings (mpicc mpicxx mpifort) version "..version.."for intel/19.1")
...
(intel/19.1) module should (and automatically will) be loaded first.
...
The full version is: 4.0.3rc3-intel-20.0
