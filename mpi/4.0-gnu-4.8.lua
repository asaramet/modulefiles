...
# Module:          mpi/openmpi/4.0.3rc3-gnu-4.8
# Revision:        esbw11
# TargetSystem:    RHEL64
# MainLocation:    /opt/bwhpc/common/mpi/openmpi/4.0.3rc3-gnu-4.8
# Status:          optional
...
local version  = "4.0.3rc3-gnu-4.8"
...
whatis("OpenMPI bindings (mpicc mpicxx mpifort) version "..version.."for gnu/4.8")
...
(gnu/4.8) module should (and automatically will) be loaded first.
...
The full version is: 4.0.3rc3-gnu-4.8
...
local compiler_version = "4.8"
local compiler_name    = "gnu"
